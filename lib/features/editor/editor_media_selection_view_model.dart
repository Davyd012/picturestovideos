...
final editorMediaSelectionViewModelProvider = NotifierProvider<
    EditorMediaSelectionViewModel, EditorMediaSelectionState>(
  EditorMediaSelectionViewModel.new,
);

class EditorMediaSelectionViewModel extends Notifier<EditorMediaSelectionState> {
  ...
  EditorMediaSelectionState build() {
    ref.read(appLoggerProvider).info(
      _tag,
      'Initializing editor media selection state',
    );
  ...
  void addMedia(LibraryMediaItem item) {
    ...
    ref.read(appLoggerProvider).info(
      _tag,
      'Adding media ${item.id} to editor selection',
    );
  ...
  void removeMedia(String mediaId) {
    ref.read(appLoggerProvider).info(
      _tag,
      'Removing media $mediaId from editor selection',
    );
    state = state.copyWith(
